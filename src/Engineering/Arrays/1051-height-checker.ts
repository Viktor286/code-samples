...
// if we compare sorted = [1, 1, 1, 2, 3, 4] to the original input = [1, 1, 4, 2, 1, 3], we notice that sorted[i] == input[i] for i = 0, 1, 3 and hence the remaining elements in indexes 2, 4, 5 are out of place. So the answer is 3.
