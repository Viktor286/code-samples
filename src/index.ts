...
console.log(preOrderIterativeTraverse(BinaryTreeRig.deserializeTree(SerializedTreeList[4])));
console.log(preOrderRecursiveTraverse(BinaryTreeRig.deserializeTree(SerializedTreeList[4])));
